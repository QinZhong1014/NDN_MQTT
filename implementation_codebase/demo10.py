...
def on_interest(name: FormalName, param: InterestParam, _app_param: Optional[BinaryStr]):
    ...
    if  (subsription_name not in repository):
        #loop_started = True """Here commented unlike demo8"""
        #client.loop_start() """Here commented unlike demo8"""
    ...
    #client.loop_stop()
    #loop_started = False """Here commented unlike demo8"""
    MAX = MAX+1
